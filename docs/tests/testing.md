...
| [x] TC-63 | Intégration | PHPUnit | Backend |  | S1 - Connexion | Tentatives répétées de connexion échouées [À implémenter] | 5+ tentatives avec mauvais mot de passe | Accès temporairement bloqué | Partitionnement d'équivalence | ❌ INVALIDE |
